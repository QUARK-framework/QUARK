...
class SV1(Braket):
    """
    Class for using the SV1 simulator on Amazon Braket
    """

    def __init__(self, device_name: str, device_arn: str = 'arn:aws:braket:::device/quantum-simulator/amazon/sv1'):
        """
        Constructor method
        """
