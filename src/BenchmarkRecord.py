...
class BenchmarkRecord:
    ...
    def append_module_record_right(self, module_record: Metrics):
        ...
        :param module_record: instance of Metrics class which should be appended on the end of the linked list
        :type: Metrics
        :rtype: None
        """
    ...
    def append_module_record_left(self, module_record: Metrics) -> None:
        ...
        :param module_record: Metrics instance which should be appended in the beginning of the linked list
    ...
    def hash_config(self, llist: deque) -> dict:
        """
        Recursively traverse through linked list and add the items to the dict

        :param llist: Linked list
        :type llist: deque
        :return: Dictionary with the module and of all its submodules
        :rtype: dict
        """
    ...
    def start_hash_config(self) -> int:
        """
        Recursively creates dict containing the name of the module and its config for all modules in a chain.
    ...
    def linked_list_to_dict(self, llist: deque, module_level: int = 0) -> dict:
        """
        Recursively traverse through linked list and add the items of the metrics objects to one single dict.

        :param module_level: current level in chain, 0 is the start
    ...
    def start_linked_list_to_dict(self) -> None:
        ...
        :return: results of linked_list_to_dict
        :rtype: dict
        """
        list_copy = deepcopy(self.linked_list_metrics)
    ...
    def get(self) -> dict:
        """
        Returns a dictionary containing all overall benchmark information and a nested dictionary, where each level
