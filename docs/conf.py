...
# The language of content autogenerated by Sphinx. Refer to documentation
# for a list of supported languages.
#
# This is also used if you translate content via gettext catalogs.
...
# to template names.
# The default sidebars (for documents that do not match any pattern) are
# defined by the theme. Built-in themes are using these templates by
...
latex_documents = [
    (main_doc, 'QUARK.tex', 'QUARK Documentation',
...
man_pages = [
    (main_doc, 'quark', 'QUARK Documentation',
     [author], 1)
]
