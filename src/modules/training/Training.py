...
class Training(Core, ABC):
    ...
    def sample_from_pmf(self, pmf, n_shots) -> np.ndarray:
        """
    ...
    def kl_divergence(self, pmf_model, pmf_target) -> float:
        """
        ...
        :param pmf_model: Probability mass function of the target distribution
        :type pmf_model: np.ndarray
    ...
    def nll(self, pmf_model, pmf_target) -> float:
        """
    ...
    def mmd(self, pmf_model, pmf_target) -> float:
        """
