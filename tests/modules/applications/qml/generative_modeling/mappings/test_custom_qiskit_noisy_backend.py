...
class TestCustomQiskitNoisyBackend(unittest.TestCase):
    ...
    @patch("modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.Aer.get_backend")
    ...
    @patch(
        "modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.Layout"
    )
    @patch(
        "modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.PassManager"
    )
    @patch(
        "modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.transpile"
    )
    @patch(
        "modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.AerSimulator"
    )
    @patch(
    ...
    @patch("modules.applications.qml.generative_modeling.mappings.custom_qiskit_noisy_backend.noise.depolarizing_error")
