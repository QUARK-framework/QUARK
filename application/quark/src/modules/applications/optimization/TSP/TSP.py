...
class TSP(Optimization):
    ...
    def generate_problem(self, config: Config, **kwargs) -> nx.Graph:
        """
    ...
    def process_solution(self, solution: dict, **kwargs) -> (list, float):
        """
    ...
    def validate(self, solution: list, **kwargs) -> (bool, float):
        """
