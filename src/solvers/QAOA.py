...
class QAOA(Solver):
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.device_options = ["LocalSimulator", "arn:aws:braket:::device/quantum-simulator/amazon/sv1",
                               "arn:aws:braket:::device/quantum-simulator/amazon/tn1",
                               "arn:aws:braket:::device/qpu/ionq/ionQdevice",
                               "arn:aws:braket:::device/qpu/rigetti/Aspen-9"]

    def get_device(self, device_option: str) -> Union[Ionq, SV1, TN1, Rigetti, LocalSimulator]:
        ...
        elif device_option == "LocalSimulator":
...
def objective_function(params, device, ising, n_qubits, n_shots, tracker, s3_folder, verbose):
    ...
    if device.name == "DefaultSimulator" or device.name == "StateVectorSimulator":
